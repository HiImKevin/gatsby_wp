    ...
    <div>
      <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
        <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
          ...
          <div className="lg:col-span-2 p-12 rounded-md shadow-2xl bg-white">
            <ul
              role="list"
              ...
              {people.map(person => (
                <li key={person.name}>
                  <div className="space-y-4">
                    <div className="aspect-w-3 aspect-h-2 max-w-xs">
                      <img
                    ...
                    <div className="text-lg leading-6 font-medium space-y-1">
                      <h3>{person.name}</h3>
                      <p className="text-primaryDarker">{person.role}</p>
                    </div>
